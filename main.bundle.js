...
/***/ function(module, exports, __webpack_require__) {
	...
	const Messages = __webpack_require__(8);
	    ...
	    if (messageObject.user === 'user') {
	      $messageList.append(`
	        <article class="message-js ${messageObject.user}-message-container message-container" id="${messageObject.id}">
	          ...
	          <button class="delete-button-js delete-button" role='delete'></button>
	        </article>
	        `);
	    } else {
	      $messageList.append(`
